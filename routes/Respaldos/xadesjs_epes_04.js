...
//  xml.SignedProperties.SignedSignatureProperties.Id =vsign_id;
  //  xml.SignaturePolicyId  = POLITICA_FIRMA;
   ...
   //().format('YYYY-MM-DD\THH:mm:ssZ'); 
    ...
    //var pxmlString = '<player bats="left" id="10012" throws="right">\n\t<!-- Here\'s a comment -->\n\t<name>Alfonso Soriano</name>\n\t<position>2B</position>\n\t<team>New York Yankees</team>\n</player>';
   /* var res;
    var vsql = "SELECT  trbf_gen_doc_xml(150,'01') Xml_str "; 
    var vparam = [150,'01' ]; 
    var resultado = await database.query(vsql);  //,vparam)  ;  
    */
    ...
    const signedXml = await xml.Sign(               // Signing document 
        ...
        //signedXml._ObjectList.items[0]._QualifyingProperties.SignedProperties.SignedSignatureProperties.SignaturePolicyIdentifier.SignaturePolicyId.SigPolicyId.Identifier.Qualifier= potros_datos.SigPolicyId_Identifier ;
        //signedXml._ObjectList.items[0]._QualifyingProperties.SignedProperties.SignedSignatureProperties.SignaturePolicyIdentifier.SignaturePolicyId.SigPolicyId.Identifier.Value= potros_datos.SigPolicyId_Identifier ;
        //signedXml._ObjectList.items[0]._QualifyingProperties.SignedProperties.SignedDataObjectProperties.
        //console.log(signedXml._ObjectList.items[0]._QualifyingProperties.SignedProperties.SignedDataObjectProperties);
        ...
        //signedXml._ObjectList.items[0]._QualifyingProperties.SignedProperties._SignedSignatureProperties._SigningTime= "SignedProperties-Signature-" + potros_datos.signatureID ;
        
     //   console.log(signedXml._ObjectList.items[0]._QualifyingProperties.SignedProperties._SignedSignatureProperties._SigningTime);
        
        
        //signedXml._SignatureValue.Id= "SignatureValue-"+potros_datos.signatureID ;        
        //signedXml._SignatureValue._Id= "SignatureValue-"+potros_datos.signatureID ;
   ...
   console.log(signedXml.toString('base64'));
